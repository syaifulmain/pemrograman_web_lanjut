            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-sm table-bordered table-striped">
                        <tr>
                            <th class="text-right col-3">Kode Transakasi:</th>
                        ...
                        <tr>
                            <th class="text-right col-3">Total Barang:</th>
                            <td class="col-9">{{ $penjualan->total_item }}</td>
                        </tr>
                        <tr>
                            <th class="text-right col-3">Total Pembelian</th>
                            <td class="col-9">IDR {{ number_format($penjualan->total_pembelian, 0, ',', '.') }}</td>
                        </tr>
                    </table>
                </div>
